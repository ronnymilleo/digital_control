...
[[nodiscard]] TuneResult auto_tune_pid_step_default(const std::function<std::unique_ptr<IPlant>()> &plant_factory,
                                                    double r, double dt, double t_end, double umin, double umax,
                                                    double alpha = 0.7, int kp_points = 8, int ki_points = 6,
                                                    int kd_points = 5);
